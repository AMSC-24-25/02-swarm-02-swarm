CXX=g++
INCLUDE=-I./include
CXXFLAGS=--std=c++17 -Wall -Wextra -Wpedantic -Werror -Wshadow
...
debug: $(DEBUG_OBJS)
	...
	$(CXX) $(CXXFLAGS) $(INCLUDE) $(DEBUGFLAGS) exec/TestRastrigin.cpp -o build/TestRastrigin $^
...
release: $(RELEASE_OBJS)
	...
	$(CXX) $(CXXFLAGS) $(INCLUDE) $(OPTFLAGS) exec/TestRastrigin.cpp -o build/TestRastrigin $^

benchmark: $(RELEASE_OBJS)
	$(CXX) bench/benchmark_test.cpp $(INCLUDE) $(OPTFLAGS) -isystem benchmark/include -Lbenchmark/build/src $(BENCHFLAGS) -o build/mm $^
